...
namespace App\digitcorp\crm\module\entreprise\Controller;

use App\digitcorp\crm\module\entreprise\Entity\Entreprise;
use App\digitcorp\crm\module\entreprise\Form\EntrepriseType;
...
class EntrepriseController extends AbstractController
{
    ...
    {
        return $this->render('entreprise/Twig/entreprise/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('entreprise/Twig/entreprise/new.html.twig', [
    ...
    {
        return $this->render('entreprise/Twig/entreprise/show.html.twig', [
            'entreprise' => $entreprise,
        ]);
    }
    ...
    public function edit(Request $request, Entreprise $entreprise): Response
    {
        ...
        return $this->render('entreprise/Twig/entreprise/edit.html.twig', [
            'entreprise' => $entreprise,
            'form' => $form->createView(),
        ]);
    }
