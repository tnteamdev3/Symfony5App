...
class UserController extends AbstractController
{
    ...
    {
        return $this->render('user/Twig/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('user/Twig/new.html.twig', [
            'user' => $user,
    ...
    {
        return $this->render('user/Twig/show.html.twig', [
            'user' => $user,
        ]);
    }
    ...
    public function edit(Request $request, User $user): Response
    {
        ...
        return $this->render('user/Twig/edit.html.twig', [
            'user' => $user,
            'form' => $form->createView(),
        ]);
    }
